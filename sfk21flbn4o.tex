...
\begin{aligned}
    ...
    =  |\beta_1(t) \rangle_1 \otimes |\beta_2(t)\rangle_2 \otimes   \sum_{\substack{v \in \{v_i\} w \in \{v_i\}}} \sigma(t,v,w)|v\rangle_1 \otimes |v\rangle_2
\end{aligned}
\end{equation}
となる。ただし、簡単のために$\mathcal{H}_1^t = \mathcal{H}_2^t$とし、その正規直行基底を離散的な$\{|v_i\rangle\}$とした。\\
　