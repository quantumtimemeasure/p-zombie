...
\begin{equation}
\begin{aligned}
    e^{-iHt}|0\rangle_1 \otimes |0\rangle_2 \otimes \ldots \otimes |M,\mathbf{V},\beta \rangle_{n(0)} \otimes |0\rangle_{n+1} \ldots \otimes |M',\mathbf{V}',\beta \rangle_{mn(0)} \otimes |0\rangle_{n+1} \ldots \\
    =  |0\rangle_{1} \otimes |0\rangle_{2} \otimes \ldots \otimes |M,\mathbf{V},\beta \rangle_{n(t)} \otimes |0\rangle_{n(t)+1} \ldots
\end{aligned}
\end{equation}　