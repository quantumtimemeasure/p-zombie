...
\begin{equation}
   ...
   \int \cdots \int \prod_p \mathrm{d}V_x \int \cdots \int \prod_p \mathrm{d}V_y \int \cdots \int \prod_p \mathrm{d}V_z \; \varphi(\{\rho_p\},\{V_{p_x}\},\{V_{p_y}\},\{V_{p_z}\}) \bigotimes_p \ket{\rho_p,P_p,\bm{V}_p} \in \bigotimes_p \mathcal{H}_p^a
\end{equation}
